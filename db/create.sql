...
insert into products (name, description, code, price, stock_id, interest_id, deliverytime_id, category, accessoires) values ('Audi RSQ8', 'De vierwielaangedreven auto heeft een benzinemotor en levert een maximum vermogen van 441 kW (600 pk) en een maximum koppel van 800 Nm. Het gemiddeld verbruik bedraagt volgens de fabrikant 13,2 l/100km (1 op 7,6).', ' 564376537-3', 220000, 'Out of stock', 'New', 2,  'SUV, Coupé' , 'A.C., Nav., A.B.');
