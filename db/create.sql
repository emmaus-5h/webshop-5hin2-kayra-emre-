...
--time
  insert into deliverytime (deliverytime) values ('Regular, 3 months');
  insert into deliverytime (deliverytime) values ('Fast Service, 6 weeks');
