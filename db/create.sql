...
--Audi
insert into products (name, description, code, price, stock_id, interest_id, time_id, category, accessoires) values ('Audi RS6', 'De vierwielaangedreven auto heeft een mild-hybrid benzinemotor en levert een maximum vermogen van 441 kW (600 pk) en een maximum koppel van 800 Nm. Het gemiddeld verbruik bedraagt volgens de fabrikant 12,4 l/100km (1 op 8,1).', '206873206-8', 210000 ,1, 3, 1, 5 , 3);
insert into products (name, description, code, price, stock_id, interest_id, time_id, category, accessoires) values ('Audi RSQ8', 'De vierwielaangedreven auto heeft een benzinemotor en levert een maximum vermogen van 441 kW (600 pk) en een maximum koppel van 800 Nm. Het gemiddeld verbruik bedraagt volgens de fabrikant 13,2 l/100km (1 op 7,6).', '564376537-3', 220000, 2, 1, 2, 3, 1);
