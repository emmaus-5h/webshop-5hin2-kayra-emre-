...
function getProducts(request, response) {
  ...
  let data = []
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.description AS description, products.code AS code, products.price AS price, products.accessoires, products.deliverytime_id, products.category, products.interest_id, products.stock_id FROM products ORDER BY id ASC');
